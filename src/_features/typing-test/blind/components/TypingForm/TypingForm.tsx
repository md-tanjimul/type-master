...
import { InitialState, Statistics, AllCharsAverageSpeedAndAccuracyByCategory } from "@/_features/typing-test/blind/types";
...
const TypingForm = ({
  ...
  return (
    <form className="flex flex-col">
      ...
      <InputBox
        isInputMatch={targetText.includes(statistics.lockedText + statistics.inputBoxValue)}
        ...
        handleTypingInputOnKeyDown={ (e) => handleTypingInputOnKeyDown(e, statistics, setStatistics) }
      />
