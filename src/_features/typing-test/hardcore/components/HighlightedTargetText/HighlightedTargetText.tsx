...
const HighlightedTargetText = ({ targetText, statistics, setStatistics, initialState, setInitialState, isStarted, isFetchingTargetText, children, timeRemain, setTimeRemain, inputBoxCaretPos }: HighlightedTargetTextProps) => {
