...
import {
  ...
  InitialState,
  Statistics
} from '@/_features/typing-test/hardcore/types';
...
export default function HardcoreMode({ mode }: { mode: string }) {
  ...
  return (
    <>
      ...
      <HighlightedTargetText targetText={TARGET_TEXT} statistics={statistics} setStatistics={setStatistics} initialState={initialState} setInitialState={setInitialState} isStarted={initialState.isStarted} isFetchingTargetText={isFetchingTargetText} timeRemain={timeRemain} setTimeRemain={setTimeRemain} inputBoxCaretPos={inputBoxCaretPos} >
