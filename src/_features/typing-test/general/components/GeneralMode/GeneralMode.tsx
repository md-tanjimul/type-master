...
import {
  ...
  InitialState,
  Statistics
} from '@/_features/typing-test/general/types';
...
import { handleStartTyping, handleTypingInputChange, handleTypingInputOnKeyDown, handleTypingInputOnClick, handleTypingInputOnKeyUp } from '../../handlers';
...
export default function GeneralMode({ mode }: { mode: string }) {
