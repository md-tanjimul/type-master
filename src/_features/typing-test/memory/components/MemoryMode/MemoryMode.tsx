...
import {
  ...
  InitialState,
  Statistics
} from '@/_features/typing-test/memory/types';


// ----- handlers importing -----

// import { handleStartTyping, handleTypingInputChange, handleTypingInputOnKeyDown } from "@/_features/typing/handlers";

import { handleStartTyping, handleTypingInputChange, handleTypingInputOnKeyDown } from '../../handlers';
...
export default function MemoryMode({ mode }: { mode: string }) {
  ...
  return (
    <>
      ...
      <h1 className="text-center text-4xl w-[60%] capitalize">{mode} Mode</h1>
      ...
      <HighlightedTargetText targetText={TARGET_TEXT} statistics={statistics} initialState={initialState} setInitialState={setInitialState} isStarted={initialState.isStarted} isFetchingTargetText={isFetchingTargetText} timeRemain={timeRemain} setTimeRemain={setTimeRemain} >
